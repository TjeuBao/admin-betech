...
RSpec.describe JobSubmission, type: :controller do
  describe 'POST create' do
    context 'with invalid attributes' do
      let(:empty_job_submission_params) { attributes_for(:job_submission, :empty) }
    ...
    context 'Career was successfully created' do
      let(:valid_job_submisstion_param) { attributes_for(:job_submisstion) }
